...
#   Rscript dev/run-tests.R weibull          # one file by name (exponential/weibull/gompertz/mspline/pkpd/bsv/covariates)
...
files <- switch(group,
    ...
    stop("Unknown group '", group, "'. Use one of: all, ode, legacy, ",
        "exponential, weibull, gompertz, mspline, pkpd, bsv, covariates.",
        call. = FALSE)
)
