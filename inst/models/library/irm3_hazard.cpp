Model file:  irm3_hazard.cpp
[PROB]
# Model: `Response-driven hazard (IRM3), in-solver event detection`
  - Author: Carlos Traynor
  - Date: `r Sys.Date()`
  - Version: `r packageVersion("mrgsolve")`

  Backbone: `mrgsolve::modlib("irm3")` (indirect response model, type 3
  -- stimulation of response production; two-compartment PK, optional
  ...
  irm2_hazard.cpp/irm4_hazard.cpp, only the backbone RESP dynamics
  differ:
  ...
  *above* baseline harmful (raises the hazard); negative makes it
  ...
  H0/beta_r/RESP0/CL/V2/Q/V3/KA/KA2/KIN/KOUT/EC50/EMAX/n/VMAX/KM
  ...
  "irm3_hazard", omega = ...)` applies BSV via per-subject `idata`
  ...
  this order): CL, V2, Q, V3, KA, KA2, KIN, KOUT, EC50, EMAX, n, VMAX,
